...
latex_documents = [
    (master_doc, "django_opensearch_models.tex", "Django OpenSearch Models Documentation", author, "manual"),
]
...
man_pages = [(master_doc, "django_opensearch_models", "Django OpenSearch Models Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        "Django OpenSearch Models Documentation",
        author,
        "django_opensearch_models",
        "opensearch-py integration in Django",
        "Miscellaneous",
    ),
]
