...
from .apps import OpenSearchConfig
...
class DocumentRegistry:
    ...
    def register_document(self, document):
        ...
        django_attr.auto_refresh = getattr(django_meta, "auto_refresh", OpenSearchConfig.auto_refresh_enabled())
        ...
        default_index_settings = deepcopy(OpenSearchConfig.default_index_settings())
    ...
    def update_related(self, instance, **kwargs):
        ...
        if not OpenSearchConfig.autosync_enabled():
            return
